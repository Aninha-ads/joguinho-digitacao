...
- **Prompt(s) Utilizado(s): Os caracteres especiais não funcionam, o enter não funciona e alguns caracteres digitados aparecem diferentes do texto original. Ajuste a lógica do keydown para capturar corretamente o que o jogador digita [parte do código com erro].
